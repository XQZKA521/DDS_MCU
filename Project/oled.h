...
//修改为M0
//PA2
#define OLED_CS_Clr()  DL_GPIO_clearPins(GPIOC,GPIO_GRP_0_CS_PIN)
#define OLED_CS_Set()  DL_GPIO_setPins(GPIOC,GPIO_GRP_0_CS_PIN)


//#define OLED_RST_Clr()  ;
//#define OLED_RST_Set()  ;
#define OLED_RST_Clr() DL_GPIO_clearPins(GPIOB, GPIO_GRP_0_RES_PIN)
#define OLED_RST_Set() DL_GPIO_setPins(GPIOB, GPIO_GRP_0_RES_PIN)

#define OLED_DC_Clr() DL_GPIO_clearPins(GPIOC,GPIO_GRP_0_DC_PIN)
